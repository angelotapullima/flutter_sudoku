                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          GridView.count(
                            ...
                            children: [
                              _buildModernDifficultyCard(context, ref, title: 'Iniciado', icon: '🌱', bestTime: storage.getBestTime('Fácil'), accentColor: Colors.tealAccent, isDark: isDark, isLandscape: isLandscape || isDesktop),
                              _buildModernDifficultyCard(context, ref, title: 'Cadete', icon: '🛡️', bestTime: storage.getBestTime('Fácil'), accentColor: Colors.teal, isDark: isDark, isLandscape: isLandscape || isDesktop),
                              _buildModernDifficultyCard(context, ref, title: 'Explorador', icon: '🚀', bestTime: storage.getBestTime('Fácil'), accentColor: Colors.cyan, isDark: isDark, isLandscape: isLandscape || isDesktop),
                              _buildModernDifficultyCard(context, ref, title: 'Viajero', icon: '⚡', bestTime: storage.getBestTime('Medio'), accentColor: Colors.blueAccent, isDark: isDark, isLandscape: isLandscape || isDesktop),
                              _buildModernDifficultyCard(context, ref, title: 'Estratega', icon: '🧠', bestTime: storage.getBestTime('Medio'), accentColor: Colors.indigoAccent, isDark: isDark, isLandscape: isLandscape || isDesktop),
                              _buildModernDifficultyCard(context, ref, title: 'Experto', icon: '🔮', bestTime: storage.getBestTime('Difícil'), accentColor: Colors.purpleAccent, isDark: isDark, isLandscape: isLandscape || isDesktop),
                              _buildModernDifficultyCard(context, ref, title: 'Maestro', icon: '🔱', bestTime: storage.getBestTime('Difícil'), accentColor: Colors.deepOrangeAccent, isDark: isDark, isLandscape: isLandscape || isDesktop),
                              _buildModernDifficultyCard(context, ref, title: 'Leyenda del Cosmos', icon: '👑', bestTime: storage.getBestTime('Experto'), accentColor: Colors.redAccent, isDark: isDark, isLandscape: isLandscape || isDesktop),
                            ],
                          ),
                        ],
                      ),
